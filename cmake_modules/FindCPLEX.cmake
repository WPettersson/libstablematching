...
IF(CPLEX_INCLUDE_DIR AND EXISTS "${CPLEX_INCLUDE_DIR}/ilcplex/cplex.h")
  ...
  find_library(_CPLEX_CONCERT_LIBRARIES NAMES concert
    HINTS "${CPLEX_ROOT}/concert/lib/${_CPLEX_LIBRARY_HINT}/static_pic/")

  IF(_CPLEX_CONCERT_LIBRARIES)
    GET_FILENAME_COMPONENT(CPLEX_CONCERT_LIBRARY_PATH ${_CPLEX_CONCERT_LIBRARIES} PATH)
    IF(CPLEX_CONCERT_LIBRARY_PATH)
      SET(CPLEX_CONCERT_LIBRARY "concert")
    ENDIF(CPLEX_CONCERT_LIBRARY_PATH)
  ENDIF(_CPLEX_CONCERT_LIBRARIES)

  find_library(_CPLEX_ILO_LIBRARIES NAMES ilocplex
    HINTS "${CPLEX_ROOT}/cplex/lib/${_CPLEX_LIBRARY_HINT}/static_pic/")

  IF(_CPLEX_ILO_LIBRARIES)
    GET_FILENAME_COMPONENT(CPLEX_ILO_LIBRARY_PATH ${_CPLEX_ILO_LIBRARIES} PATH)
    IF(CPLEX_ILO_LIBRARY_PATH)
      SET(CPLEX_ILO_LIBRARY "ilocplex")
    ENDIF(CPLEX_ILO_LIBRARY_PATH)
  ENDIF(_CPLEX_ILO_LIBRARIES)
